...
YAML_VALID_TOP_LEVEL_OPERATORS = {OPERATORS.AND, OPERATORS.AND_ALL, OPERATORS.AND_EITHER}
YAML_ALL_VALID_RULE_KEYS = set([INVERSE_PATTERN_NAMES_MAP[k] for k in YAML_VALID_TOP_LEVEL_OPERATORS]).union(YAML_MUST_HAVE_KEYS)
