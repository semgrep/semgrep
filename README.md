...
An install script is also available with each [release](https://github.com/returntocorp/semgrep/releases/download/v0.14.0/semgrep-v0.14.0-ubuntu-generic.sh) if you want a native binary.

```bash
$ ./semgrep-v0.14.0-ubuntu-generic.sh
```
