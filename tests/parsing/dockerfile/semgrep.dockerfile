...
# The docker base image below in the FROM currently uses OCaml 5.1
# See https://github.com/returntocorp/ocaml-layer/blob/master/configs/alpine5.sh
#
...
FROM returntocorp/ocaml:alpine5.1-2023-10-05 as build-semgrep-core
