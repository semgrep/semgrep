...
class FakeModel(models.Model):
    # ok
    fieldChar = models.CharField(max_length=200, blank=True)
    # ok
    ...
    fieldInt = models.IntegerField(blank=True, max_value=30)
    # ok
    fieldIntNull = models.IntegerField(null=True, blank=True, max_value=100)
