...
|             |                                         |                                                                               |                                                                                            |                                                                                                                                                                                       |                |
| Value       |                                         |                                                                               |                                                                                            |                                                                                                                                                                                       |                |
|             | Engine requested                        | The engine requested by the user                                              | Understand which engines are being used; debug engine-specific problems                    | `"OSS"`
|             | Engine configuration                    | More granular information about the requested engine configuration            | Understand which engines are being used; debug engine-specific problems                    | `{ type: "PRO", analysis_type: "Interfile", pro_langs: true }`                                                                                                                                                                         | str            |
