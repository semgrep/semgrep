...
and m_compatible_type matching t e =
  ...
  (* for java literals *)
  | A.TyName (("int", _), _), B.L (B.Int _) -> envf matching (B.E e)
  | A.TyName (("float", _), _), B.L (B.Float _) -> envf matching (B.E e)
  | A.TyName (("str", _), _), B.L (B.String _) -> envf matching (B.E e)
  (* for matching ids *)
