...
*)
val loc : _ t -> (Parse_info.t * Parse_info.t) option

(* Same as loc but return fake tokens in case the tree is empty *)
val unsafe_loc : _ t -> Parse_info.t * Parse_info.t
...
val visit :
  v_tok:(Parse_info.t -> unit) -> v_any:('any -> unit) -> 'any t -> unit
