...
let e2e_ci_path =
  "../../../../semgrep/tests/e2e/snapshots/test_ci/test_full_run"
...
let semgrep_core_output =
  pack_tests "semgrep core JSON output"
    (let dir = Filename.concat tests_path "OTHER/semgrep_output/core_output" in
...
let semgrep_cli_output =
  pack_tests "semgrep CLI JSON output"
    (let dir = Filename.concat tests_path "OTHER/semgrep_output/cli_output" in
...
let semgrep_scans_output =
  pack_tests "semgrep scans JSON output"
    (let dir = Filename.concat tests_path "OTHER/semgrep_output/scans_output" in
     let files =
...
let tests =
  List.flatten [ semgrep_core_output; semgrep_cli_output; semgrep_scans_output ]
