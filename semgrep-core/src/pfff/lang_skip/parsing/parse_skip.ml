...
type program_and_tokens = Ast_skip.program option * Parser_skip.token list
...
let tokens a = Common.profile_code "Parse_skip.tokens" (fun () -> tokens2 a)
...
let parse a = Common.profile_code "Parse_skip.parse" (fun () -> parse2 a)
