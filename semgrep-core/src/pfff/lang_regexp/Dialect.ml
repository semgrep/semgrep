...
let pcre_extended =
  { default_conf with ignore_whitespace = true; ignore_hash_comments = true }

(* https://perldoc.perl.org/perlre *)
let perl = pcre
let perl_x = pcre_extended
let perl_xx = { pcre_extended with ignore_whitespace_in_char_classes = true }

(* https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions/Cheatsheet *)
let javascript = { pcre with pcre_javascript_compat = true }
...
let go = { default_conf with with_comment_groups = false }
