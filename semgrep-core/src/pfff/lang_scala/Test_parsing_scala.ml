...
let actions () =
  [
    ("-tokens_scala", "   <file>", Common.mk_action_1_arg test_tokens);
    ("-parse_scala", "   <files or dirs>", Common.mk_action_n_arg test_parse);
    ("-dump_scala", "   <file>", Common.mk_action_1_arg test_dump);
  ]
