...
let tof_name = OCaml.add_new_type "name" (OCaml.Apply ("wrap", OCaml.String))
  ...
  OCaml.add_new_type "resolved_name"
    (OCaml.Sum
       [
         ("Local", []);
         ("Param", []);
         ("Global", [ OCaml.Var "qualified_name" ]);
         ("NotResolved", []);
       ])
  ...
  OCaml.add_new_type "special"
    (OCaml.Sum
       [
         ...
         ("YieldStar", []);
         ("Await", []);
         ("Encaps", [ OCaml.Option (OCaml.Var "name") ]);
         ("UseStrict", []);
         ("And", []);
         ("Or", []);
         ("Not", []);
...
let tof_label = OCaml.add_new_type "label" (OCaml.Apply ("wrap", OCaml.String))
       ...
       [
         ( "Field",
           [
             ...
             OCaml.List (OCaml.Var "property_prop");
             OCaml.Var "expr";
           ] );
  ...
  OCaml.add_new_type "var"
    (OCaml.Dict
       [
         ...
         ("v_resolved", `RO, OCaml.Apply ("ref", OCaml.Var "resolved_name"));
       ])
  ...
  OCaml.add_new_type "toplevel"
    (OCaml.Sum
       [
         ...
         ("Import", [ OCaml.Var "name"; OCaml.Var "name"; OCaml.Var "filename" ]);
