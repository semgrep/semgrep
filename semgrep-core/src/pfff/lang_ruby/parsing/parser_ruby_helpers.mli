...
val methodcall :
  Ast_ruby.expr ->
  Ast_ruby.argument list Ast_ruby.bracket ->
  Ast_ruby.expr option ->
  Ast_ruby.expr
...
val scope :
  Ast_ruby.tok ->
  Ast_ruby.expr ->
  Ast_ruby.variable_or_method_name ->
  Ast_ruby.expr
...
val merge_binop : (Ast_ruby.expr * 'a * 'b) list -> Ast_ruby.expr list * 'a * 'b
...
val merge_argument :
  string ->
  (Ast_ruby.argument * 'a * 'b) list ->
  Ast_ruby.argument list * 'a * 'b

val merge_method_name :
  string ->
  (Ast_ruby.method_name * 'a * 'b) list ->
  Ast_ruby.method_name list * 'a * 'b

val merge_method_kind :
  string ->
  (Ast_ruby.method_kind * 'a * 'b) list ->
  Ast_ruby.method_kind list * 'a * 'b

val merge_stmt : (Ast_ruby.expr * 'a * 'b) list -> Ast_ruby.expr list * 'a * 'b
...
val merge_argument_list :
  string ->
  (Ast_ruby.arguments * 'a * 'b) list ->
  Ast_ruby.arguments list * 'a * 'b
...
val do_fail : string -> 'a list -> ('a -> string) -> unit
