...
val overlay_equivalences :
  dir_orig:Common.dirname -> dir_overlay:Common.dirname -> overlay

val adapt_layer : Layer_code.layer -> overlay -> Layer_code.layer
val adapt_database : Database_code.database -> overlay -> Database_code.database
...
val gen_overlay :
  dir_orig:Common.dirname ->
  dir_overlay:Common.dirname ->
  output:Common.filename ->
  unit

val adapt_layers :
  overlay:overlay ->
  dir_layers_orig:Common.dirname ->
  dir_layers_overlay:Common.dirname ->
  unit
