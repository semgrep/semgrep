...
let vof_token t = OCaml.VString (Parse_info.str_of_info t)
...
let rec vof_multi_grouped = function
  ...
  | Bracket (v1, v2, v3) ->
      ...
      and v2 = OCaml.vof_list vof_multi_grouped v2
      and v3 = vof_token v3 in
      OCaml.VSum ("Bracket", [ v1; v2; v3 ])
  | Metavar v1 ->
      let v1 = vof_wrap v1 in
      OCaml.VSum ("Metavar", [ v1 ])
  | Dots v1 ->
      let v1 = vof_token v1 in
      OCaml.VSum ("Dots", [ v1 ])
  | Tok v1 ->
      let v1 = vof_wrap v1 in
      OCaml.VSum ("Tok", [ v1 ])
...
and vof_trees xs = OCaml.VList (xs |> List.map vof_multi_grouped)
