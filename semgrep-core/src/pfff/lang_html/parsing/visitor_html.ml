...
let default_visitor =
  { kinfo = (fun (k, _) x -> k x); khtml_tree = (fun (k, _) x -> k x) }
 ...
 fun vin ->
          ...
          and v2 =
            v_list
              (fun (v1, v2) ->
                ...
                ())
              v2
          and v3 = v_list v_html_tree v3 in
          ()
      | Data v1 ->
  ...
  and v_tag = function
    | Tag v1 ->
        let v1 = v_wrap v_string v1 in
        ()
  and v_attr_name = function
    | Attr v1 ->
        let v1 = v_wrap v_string v1 in
        ()
  and v_attr_value = function
    | Val v1 ->
        let v1 = v_wrap v_string v1 in
        ()
  and v_any = function
    | HtmlTree v1 ->
        let v1 = v_html_tree v1 in
        ()
