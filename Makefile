...
install-opam-deps:
	opam update -y
	OPAMSOLVERTIMEOUT=1500 LWT_DISCOVER_ARGUMENTS="--use-libev true" LIBRARY_PATH="$(HOMEBREW_PREFIX)/lib:$(LIBRARY_PATH)" opam upgrade --confirm-level=unsafe-yes -y --fixup
