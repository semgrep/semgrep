...
ALPINE_APK_DEPS_CORE=pcre-dev pcre2-dev gmp-dev libev-dev curl-dev openssl-libs-static zlib-static
...
UBUNTU_DEPS=pkg-config libpcre3-dev libpcre2-dev libgmp-dev libev-dev libcurl4-gnutls-dev
...
# - coreutils?
# - gettext?
BREW_DEPS=pkg-config pcre pcre2 gmp libev curl coreutils gettext
