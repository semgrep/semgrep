...
RUN /home/pythonbuild/sgrep_lint/build.sh /home/opam/pythonbuild/sgrep-lint-built/
...
COPY --from=build-sgrep-lint /home/pythonbuild/sgrep-lint-built/sgrep.dist/* /bin/
