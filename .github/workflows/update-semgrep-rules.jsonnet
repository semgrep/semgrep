...
|||,
      ...
      #    GITHUB_TOKEN: "${{ steps.token.outputs.token }}"
        ...
        #TODO: this does not work :(  --reviewer r2c/pa
          ...
          run: "gh pr create --title 'Cron - update semgrep-rules' --body 'Please confirm correctness of the changes here and ensure all tests pass. This PR was autogenerated by .github/workflows/update-semgrep-rules.yml' \\\n  --base develop\n",
        },
      ],
    },
  },
