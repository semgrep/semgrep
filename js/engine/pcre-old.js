...
function pcre_compile_stub_bc(v_opt, v_tables, v_pat) {
  ...
  var error_ofs_ptr =
    pcre_wasm_module._malloc(
      4
    ); /* offset in the pattern at which error occurred */
  ...
  if (regexp_ptr == NULL) {
    ...
    throw new Error(
      errorString + " at offset " + pcre_wasm_module.HEAP8[error_ofs_ptr]
    );
  }
