...
and eval_op op values code =
  ...
  | G.Div, [ Int i1; Int i2 ] -> Int Int64_ops.(i1 / i2)
  ...
  | G.Mult, [ Int i1; Int i2 ] -> Int Int64_ops.(i1 * i2)
  ...
  | G.Plus, [ Int i1; Int i2 ] -> Int Int64_ops.(i1 + i2)
  ...
  | G.Pow, [ Int i1; Int i2 ] -> Int (Common2.power64 i1 i2)
