 ...
 *)
type tok = Tok.t_always_equal [@@deriving show, eq, ord, hash, sexp]

(* a shortcut to annotate some information with position information *)
type 'a wrap = 'a * tok [@@deriving show, eq, ord, hash, sexp]
 ...
 *)
type 'a bracket = tok * 'a * tok [@@deriving show, eq, ord, hash, sexp]
 ...
 *)
type sc = tok [@@deriving show, eq, ord, hash, sexp]
 ...
 *)
type todo_kind = string wrap [@@deriving show, eq, ord, hash, sexp]

(*****************************************************************************)
(* Names part 1 *)
(*****************************************************************************)

type ident = string wrap [@@deriving show, eq, ord, hash, sexp]
...
and id_flags = (IdFlags.t[@name "id_flags_t"] [@sexp.opaque])
and id_info_id = (IdInfoId.t[@name "id_info_id_t"] [@sexp.opaque])
...
and raw_tree = (any Raw_tree.t[@name "raw_tree_t"] [@sexp.opaque])
[@@deriving
