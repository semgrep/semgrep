...
and debugger_statement = (Token.t (* "debugger" *) * semicolon)
...
and with_statement (* inlined *) = (
    Token.t (* "with" *) * parenthesized_expression * statement
)

and while_statement (* inlined *) = (
