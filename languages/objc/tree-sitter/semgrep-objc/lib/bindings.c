/*
  Generated by ocaml-tree-sitter for objc.
*/
...
// OCaml function
CAMLprim value octs_create_parser_objc(value unit) {
  CAMLparam0();
  CAMLlocal1(v);
  ...
  if (!ts_parser_set_language(parser, tree_sitter_objc())) {
    ts_parser_delete(parser);
    caml_failwith(
      "ts_parser_set_language failed for objc: the compiled "
