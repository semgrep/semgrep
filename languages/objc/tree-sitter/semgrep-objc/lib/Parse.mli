...
(**
    Functions for parsing objc programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a objc program from a string into a typed OCaml CST.
...
(** Parse a objc program from a file into a typed OCaml CST.
