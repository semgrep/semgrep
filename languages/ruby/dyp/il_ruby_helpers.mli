...
val visit_method_param :
  cfg_visitor -> method_formal_param -> method_formal_param
...
module Abbr : sig
  ...
  val exnblock :
    stmt -> rescue_block list -> ?eelse:stmt -> ?ensure:stmt -> pos2 -> stmt
  ...
  val nameclass :
    ?lhs:lhs -> identifier -> ?inh:identifier -> stmt -> pos2 -> stmt
