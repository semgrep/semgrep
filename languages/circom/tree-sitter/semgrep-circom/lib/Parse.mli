...
(**
    Functions for parsing circom programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a circom program from a string into a typed OCaml CST.
...
(** Parse a circom program from a file into a typed OCaml CST.
