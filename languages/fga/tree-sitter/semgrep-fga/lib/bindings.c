/*
  Generated by ocaml-tree-sitter for fga.
*/
...
// OCaml function
CAMLprim value octs_create_parser_fga(value unit) {
  CAMLparam0();
  CAMLlocal1(v);
  ...
  ts_parser_set_language(parser, tree_sitter_fga());
  CAMLreturn(v);
};
