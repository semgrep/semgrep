/*
  Generated by ocaml-tree-sitter for move_on_sui.
*/
...
TSLanguage *tree_sitter_move_on_sui();
...
// OCaml function
CAMLprim value octs_create_parser_move_on_sui(value unit) {
  CAMLparam0();
  CAMLlocal1(v);
  ...
  ts_parser_set_language(parser, tree_sitter_move_on_sui());
  CAMLreturn(v);
};
