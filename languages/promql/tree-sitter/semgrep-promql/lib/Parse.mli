...
(**
    Functions for parsing promql programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a promql program from a string into a typed OCaml CST.
...
val string :
  ...
  (CST.query_, CST.extra) Tree_sitter_run.Parsing_result.t

(** Parse a promql program from a file into a typed OCaml CST.
