(* copy-paste of ../data/std.jsonnet itself coming from
 * https://github.com/google/jsonnet/blob/master/stdlib/std.jsonnet
 *)
let std =
  {|
/*
...
let get_std_jsonnet () =
  ...
  UTmp.Legacy.with_tmp_file ~str:std ~ext:"jsonnet" (fun file ->
