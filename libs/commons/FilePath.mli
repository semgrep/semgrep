(* This path type uses private variants:
   ...
   A private variant constructor is one which behaves like a regular
   constructor, but it cannot be freely used to construct values of
   the given type.
   ...
   Importantly, due to this reliance on `Unix.realpath`, this means
