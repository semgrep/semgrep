...
class virtual ['a] ocollection =
  object (o : 'o)
    ...
    method clear : unit = o#iter (fun e -> o#del2 e)
    ...
    method tolist : 'a list = List.rev (o#fold (fun acc e -> e :: acc) [])
    ...
    method exists : ('a -> bool) -> bool = fun f -> o#tolist |> List.exists f
