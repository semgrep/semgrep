...
(* internals *)
val build_with_tree : config -> Graph_code_opti.graph -> dm
val partition_matrix : Graph_code.node list -> dm -> Graph_code.node list
...
val hill_climbing : Graph_code.node list -> dm -> Graph_code.node list
