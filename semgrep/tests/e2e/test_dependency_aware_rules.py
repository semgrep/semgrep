...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("rules/dependency_aware/java-gradle-sca.yaml", "dependency_aware/gradle-target.java"),
        ("rules/dependency_aware/python-poetry-sca.yaml", "dependency_aware/poetry-target.py"),
        (
