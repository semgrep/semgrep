...
class RuleTimes:
    ...
    def from_json(cls, x: Any) -> 'RuleTimes':
        if isinstance(x, dict):
            return cls(
                rule_id=_atd_read_string(x['rule_id']) if 'rule_id' in x else _atd_missing_json_field('RuleTimes', 'rule_id'),
...
class Time:
    ...
    def from_json(cls, x: Any) -> 'Time':
        if isinstance(x, dict):
            return cls(
                targets=_atd_read_list(TargetTime.from_json)(x['targets']) if 'targets' in x else _atd_missing_json_field('Time', 'targets'),
                rules=_atd_read_list(_atd_read_string)(x['rules']) if 'rules' in x else _atd_missing_json_field('Time', 'rules'),
...
class Stats:
    ...
    def from_json(cls, x: Any) -> 'Stats':
        if isinstance(x, dict):
            return cls(
                okfiles=_atd_read_int(x['okfiles']) if 'okfiles' in x else _atd_missing_json_field('Stats', 'okfiles'),
                errorfiles=_atd_read_int(x['errorfiles']) if 'errorfiles' in x else _atd_missing_json_field('Stats', 'errorfiles'),
            )
        else:
...
class MatchExtra:
    ...
    def from_json(cls, x: Any) -> 'MatchExtra':
        if isinstance(x, dict):
            return cls(
                metavars=_atd_read_assoc_object_into_dict(MetavarValue.from_json)(x['metavars']) if 'metavars' in x else _atd_missing_json_field('MatchExtra', 'metavars'),
    ...
    def from_json(cls, x: Any) -> 'Location':
        if isinstance(x, dict):
            return cls(
                ...
                lines=_atd_read_list(_atd_read_string)(x['lines']) if 'lines' in x else _atd_missing_json_field('Location', 'lines'),
            )
        else:
...
class Match:
    ...
    def from_json(cls, x: Any) -> 'Match':
        if isinstance(x, dict):
            return cls(
                location=Location.from_json(x['location']) if 'location' in x else _atd_missing_json_field('Match', 'location'),
                extra=MatchExtra.from_json(x['extra']) if 'extra' in x else _atd_missing_json_field('Match', 'extra'),
                rule_id=RuleId.from_json(x['rule_id']) if 'rule_id' in x else None,
            )
        else:
...
class Error:
    ...
    def from_json(cls, x: Any) -> 'Error':
        if isinstance(x, dict):
            return cls(
                error_type=_atd_read_string(x['error_type']) if 'error_type' in x else _atd_missing_json_field('Error', 'error_type'),
                severity=Severity.from_json(x['severity']) if 'severity' in x else _atd_missing_json_field('Error', 'severity'),
                location=Location.from_json(x['location']) if 'location' in x else _atd_missing_json_field('Error', 'location'),
...
class MatchResults:
    ...
    def from_json(cls, x: Any) -> 'MatchResults':
        if isinstance(x, dict):
            return cls(
                matches=_atd_read_list(Match.from_json)(x['matches']) if 'matches' in x else _atd_missing_json_field('MatchResults', 'matches'),
                errors=_atd_read_list(Error.from_json)(x['errors']) if 'errors' in x else _atd_missing_json_field('MatchResults', 'errors'),
                skipped_targets=_atd_read_list(SkippedTarget.from_json)(x['skipped']) if 'skipped' in x else _atd_missing_json_field('MatchResults', 'skipped'),
                stats=Stats.from_json(x['stats']) if 'stats' in x else _atd_missing_json_field('MatchResults', 'stats'),
