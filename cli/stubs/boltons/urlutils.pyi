...
class cachedproperty(Generic[T]):
    ...
    def __get__(self, obj: URL, objtype: type | None) -> T: ...
    def __repr__(self) -> str: ...

class URL:
    def __init__(self, url: URL | bytes | str) -> None: ...
    @classmethod
    def from_parts(
        cls,
        scheme: str,
    ...
    def path(self) -> str: ...
    @property
    def uses_netloc(self) -> bool | str: ...
    @property
    def default_port(self) -> int: ...
    def normalize(self, with_case: bool) -> None: ...
    def navigate(self, dest: URL | str) -> URL: ...
...
def parse_host(host: str | None) -> tuple[socket.AddressFamily | None, str]: ...
def parse_url(url_text: str) -> dict[str, str | None] | dict[str, str]: ...
def parse_qsl(
    qs: str, keep_blank_values: bool, encoding: str
) -> list[tuple[str, None]] | list[tuple[str, str | None]] | list[tuple[str, str]]: ...
