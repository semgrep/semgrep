...
def test_additional_outputs(run_semgrep_in_tmp: RunSemgrep, snapshot):
    ...
    with open("gitlab_secrets.json") as gitlab_secrets_json:
        snapshot.assert_match(gitlab_secrets_json.read(), "gitlab_secrets.json.expected")        
...
def test_additional_outputs_with_format_flag(run_semgrep_in_tmp: RunSemgrep, snapshot, format):
    stdout, _ = run_semgrep_in_tmp(
        "rules/eqeq.yaml",
        target_name="basic/stupid.py",
        options=[
...
def test_additional_outputs_with_format_output_flag(run_semgrep_in_tmp: RunSemgrep, snapshot, format):
    stdout, _ = run_semgrep_in_tmp(
        "rules/eqeq.yaml",
        target_name="basic/stupid.py",
        options=[
